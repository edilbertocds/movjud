...
public class UsuarioAcaoType {
    ...
    public UsuarioAcaoType(PermissaoAcaoType permissaoAcao, Acao acao) {
        ...
        case PADRAO_TRUE:
            this.marcado = true;
            this.imagem = AppResourceProperties.getString("img.listaVazia"); 
            this.acao = acao;
        ...
        case CONCEDIDO:
            this.marcado = true;
            this.imagem =  AppResourceProperties.getString("img.listaAddOn"); 
            this.acao = acao;
            this.permissaoAcao = permissaoAcao;
            break;
        case REMOVIDO:
            this.marcado = false;
            this.imagem =  AppResourceProperties.getString("img.listaRemoverOn"); 
            this.acao = acao;
            this.permissaoAcao = permissaoAcao;
            break;
        }
    ...
    public static UsuarioAcaoType alterarTipoPermissao(Perfil perfilSelecionado, UsuarioAcaoType acaoCorrente,
                                                       boolean novaMarcacao, boolean novoHabilitado) {
        if (perfilSelecionado.getAcoes().contains(acaoCorrente.getAcao()) && novaMarcacao == false) {
            ...
            acaoCorrente.setImagem(AppResourceProperties.getString("img.listaRemoverOn"));
            ...
            acaoCorrente.setImagem(AppResourceProperties.getString("img.listaAddOn"));
        } else if (perfilSelecionado.getAcoes().contains(acaoCorrente.getAcao()) && novaMarcacao == true) {
            acaoCorrente.setPermissaoAcao(PermissaoAcaoType.PADRAO_TRUE);
            acaoCorrente.setImagem(AppResourceProperties.getString("img.listaVazia"));
    ...
    public static List<UsuarioAcaoType> recuperarListaPermissoes(List<Acao> listaCompleta, List<Acao> listaPerfilAcao,
                                                                 List<UsuarioAcao> listaUsuarioAcao,
                                                                 boolean novoHabilitado) {
